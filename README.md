...
```groovy
implementation 'com.github.tiamosu:X-MVVMFly:3.0.3'
```

## 可单独依赖模块：
### fly（必需）
```groovy
implementation 'com.github.tiamosu.X-MVVMFly:fly:3.0.3'
```

### fly-http（可选）
```groovy
implementation 'com.github.tiamosu.X-MVVMFly:fly-http:3.0.3'
```

### fly-imageloader-glide（可选）
```groovy
implementation 'com.github.tiamosu.X-MVVMFly:fly-imageloader-glide:3.0.3'
```
