...
```groovy
implementation 'me.tiamosu:fly:1.1.3'
```
...
```groovy
implementation 'me.tiamosu:fly-http:1.1.3'
```
...
```groovy
implementation 'me.tiamosu:fly-imageloader-glide:1.1.3'
```
...
```groovy
implementation 'me.tiamosu:fly-livedata-bus:1.1.3'
```
