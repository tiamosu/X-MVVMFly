...
```groovy
implementation 'me.tiamosu:fly:1.0.4'
```
...
```groovy
implementation 'me.tiamosu:fly-http:1.0.4'
```
...
```groovy
implementation 'me.tiamosu:fly-imageloader-glide:1.0.4'
```
...
```groovy
implementation 'me.tiamosu:fly-livedata-bus:1.0.4'
```
