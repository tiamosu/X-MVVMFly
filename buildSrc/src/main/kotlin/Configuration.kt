...
object Versions {
    ...
    const val okhttp3 = "4.4.1" //版本3.12.X，兼容Android 4
    const val glide = "4.11.0"
    const val dagger2 = "2.27"
    const val fragmentation = "1.1.7"
}

object Publish {
    const val userOrg = "weixia" //bintray.com用户名
    const val groupId = "me.tiamosu" //jcenter上的路径
    const val publishVersion = "1.0.2" //版本号
...
object Deps {
    ...
    //utilcode
    const val utilcode = "com.blankj:utilcodex:1.27.0"
