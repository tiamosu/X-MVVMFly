...
class PersistentCookieStore {
    ...
    protected fun encodeCookie(cookie: SerializableHttpCookie?): String? {
        ...
        try {
            ...
            FlyHttpLog.d("IOException in encodeCookie" + e.message)
            return null
        }
    ...
    protected fun decodeCookie(cookieString: String): Cookie? {
        ...
        try {
            ...
            FlyHttpLog.d("IOException in decodeCookie" + e.message)
        } catch (e: ClassNotFoundException) {
            FlyHttpLog.d("ClassNotFoundException in decodeCookie" + e.message)
        }
        return cookie
    }
