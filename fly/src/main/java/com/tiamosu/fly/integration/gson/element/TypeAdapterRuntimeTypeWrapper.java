...
public class TypeAdapterRuntimeTypeWrapper<T> extends TypeAdapter<T> {
    ...
    public void write(JsonWriter out, T value) throws IOException {
        ...
        final TypeAdapter chosen;
        final Type runtimeType = getRuntimeTypeIfMoreSpecific(mType, value);
        if (runtimeType != mType) {
            final TypeAdapter runtimeTypeAdapter = mGson.getAdapter(TypeToken.get(runtimeType));
