...
public class FragmentNavigator extends Navigator<FragmentNavigator.Destination> {
    ...
    FragmentNavigator(@NonNull Context context, @NonNull FragmentManager manager,
                      int containerId) {
        mContext = context;
    ...
    public NavDestination navigate(@NonNull Destination destination, @Nullable Bundle args,
        ...
        if (navigatorExtras instanceof Extras) {
            final Extras extras = (Extras) navigatorExtras;
    ...
    public void onRestoreState(@Nullable Bundle savedState) {
        if (savedState != null) {
            final int[] backStack = savedState.getIntArray(KEY_BACK_STACK_IDS);
            if (backStack != null) {
                mBackStack.clear();
    ...
    private int getDestId(@Nullable String backStackName) {
        final String[] split = backStackName != null ? backStackName.split("-") : new String[0];
        if (split.length != 2) {
    ...
    public static class Destination extends NavDestination {
         ...
         */
        Destination(@NonNull Navigator<? extends Destination> fragmentNavigator) {
        ...
        public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs) {
            ...
            final String className = a.getString(R.styleable.FragmentNavigator_android_name);
            if (className != null) {
         ...
         */
        @NonNull
        final Destination setClassName(@NonNull String className) {
    ...
    public static final class Extras implements Navigator.Extras {
         ...
         */
        @NonNull
        Map<View, String> getSharedElements() {
        ...
        public static final class Builder {
            ...
            public Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
                for (Map.Entry<View, String> sharedElement : sharedElements.entrySet()) {
                    final View view = sharedElement.getKey();
                    final String name = sharedElement.getValue();
             ...
             */
            @NonNull
            Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
