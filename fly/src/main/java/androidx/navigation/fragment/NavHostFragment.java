...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    public static NavController findNavController(@NonNull Fragment fragment) {
        ...
        while (findFragment != null) {
            ...
            final Fragment primaryNavFragment = findFragment.getParentFragmentManager()
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final FragmentContainerView containerView = new FragmentContainerView(inflater.getContext());
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        final Bundle navState = mNavController.saveState();
        if (navState != null) {
